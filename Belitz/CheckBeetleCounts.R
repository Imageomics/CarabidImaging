...
firstpass_df$IndividualID_1 <- paste0("NEON.BET.", firstpass_df$domainID, ".", substr(firstpass_df$IndividualID_1, 14, nchar(firstpass_df$IndividualID_1)))
firstpass_df$IndividualID_2 <- paste0("NEON.BET.", firstpass_df$domainID, ".", substr(firstpass_df$IndividualID_2, 14, nchar(firstpass_df$IndividualID_2)))
firstpass_df$IndividualID_n1 <- paste0("NEON.BET.", firstpass_df$domainID, ".", substr(firstpass_df$IndividualID_n1, 14, nchar(firstpass_df$IndividualID_n1)))
firstpass_df$IndividualID_n <- paste0("NEON.BET.", firstpass_df$domainID, ".", substr(firstpass_df$IndividualID_n, 14, nchar(firstpass_df$IndividualID_n)))

head(firstpass_df$IndividualID_1, 10)
...
write.csv(matched_df, "./catalog_Belitz_renamedIndividualsMetadata.csv", row.names = FALSE)

write.csv(firstpass_df, "./catalog_Belitz_renamedMetadataClean.csv", row.names = FALSE)
